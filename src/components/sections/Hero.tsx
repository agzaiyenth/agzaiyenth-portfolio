...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="container flex flex-col items-center justify-center px-4 z-10">
        <span className="text-sm md:text-base font-medium tracking-wider uppercase text-accent mb-2 animate-fade-in">
          Full-Stack & AI Engineer
        </span>
        
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-center leading-tight tracking-tight mb-6 animate-fade-in">
          Agzaiyenth Ganaraj
        </h1>
        
        <h2 className="text-lg md:text-2xl text-center text-muted-foreground max-w-3xl mb-8 animate-fade-in">
          <TypewriterText 
            texts={[
